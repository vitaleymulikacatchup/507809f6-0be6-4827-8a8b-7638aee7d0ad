...
export const metadata: Metadata = {
  ...
  description: "Capture life's beautiful moments with PhotoGallery's professional photography services. Specializing in weddings, portraits, commercial, and event photography.",
  keywords: "photography, professional photographer, wedding photography, portrait photography, commercial photography, event photography",
